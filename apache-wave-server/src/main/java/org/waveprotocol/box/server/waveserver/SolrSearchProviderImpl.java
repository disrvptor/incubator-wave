...
import org.waveprotocol.wave.model.id.WaveIdImpl;
import org.waveprotocol.wave.model.id.WaveletId;
import org.waveprotocol.wave.model.id.WaveletIdImpl;
...
public class SolrSearchProviderImpl extends AbstractSearchProviderImpl {
  ...
  private void addSearchResultsToCurrentWaveView(
    ...
    while (docJsonIterator.hasNext()) {
      ...
      WaveId waveId = WaveIdImpl.deserialise(docJson.getAsJsonPrimitive(WAVE_ID).getAsString());
      WaveletId waveletId =
          WaveletIdImpl.deserialise(docJson.getAsJsonPrimitive(WAVELET_ID).getAsString());
