 ...
 *
 */
public final class AttachmentIdImpl implements Comparable<AttachmentId>, AttachmentId {
   ...
   */
  public AttachmentIdImpl(String domain, String id) {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.media.model.AttachmentId#getDomain()
 */
  @Override
public String getDomain() {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.media.model.AttachmentId#getId()
 */
  @Override
public String getId() {
    return id;
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.media.model.AttachmentId#serialise()
 */
  @Override
public String serialise() {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.media.model.AttachmentId#hashCode()
 */
  @Override
  public int hashCode() {
    final int prime = 31;
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.media.model.AttachmentId#equals(java.lang.Object)
 */
  @Override
  public boolean equals(Object obj) {
    ...
    return domain == other.getDomain() && id.equals(other.getId());
  }

  /* (non-Javadoc)
 * @see org.waveprotocol.wave.media.model.AttachmentId#toString()
 */
@Override
  ...
  public int compareTo(AttachmentId other) {
    int domainCompare = domain.compareTo(other.getDomain());
    if (domainCompare == 0) {
