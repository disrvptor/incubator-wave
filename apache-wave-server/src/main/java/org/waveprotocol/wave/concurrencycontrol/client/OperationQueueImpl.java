...
class OperationQueueImpl implements OperationQueue {
   ...
   */
  @VisibleForTesting
  OperationQueueImpl(Transformer transformer) {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.concurrencycontrol.client.OperationQueue#add(org.waveprotocol.wave.model.operation.wave.WaveletOperation)
 */
  @Override
public void add(WaveletOperation op) {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.concurrencycontrol.client.OperationQueue#insertHead(java.util.List)
 */
  @Override
public void insertHead(List<WaveletOperation> newHead) {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.concurrencycontrol.client.OperationQueue#isEmpty()
 */
  @Override
public boolean isEmpty() {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.concurrencycontrol.client.OperationQueue#estimateSize()
 */
  @Override
public int estimateSize() {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.concurrencycontrol.client.OperationQueue#take()
 */
  @Override
public List<WaveletOperation> take() {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.concurrencycontrol.client.OperationQueue#transform(java.util.List)
 */
  @Override
public List<WaveletOperation> transform(List<WaveletOperation> serverOps)
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.concurrencycontrol.client.OperationQueue#toString()
 */
@Override
  public String toString() {
