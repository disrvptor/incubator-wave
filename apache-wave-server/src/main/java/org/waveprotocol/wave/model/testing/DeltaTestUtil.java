...
import org.waveprotocol.wave.model.operation.wave.WaveletOperationUtils;
...
public class DeltaTestUtil {
  ...
  public TransformedWaveletDelta delta(long targetVersion, WaveletOperation op) {
    ...
    return WaveletOperationUtils.cloneOperations(author,
  ...
  public TransformedWaveletDelta makeTransformedDelta(long applicationTimestamp,
    ...
    return WaveletOperationUtils.cloneOperations(author, resultingVersion, applicationTimestamp,
        ops);
  }
