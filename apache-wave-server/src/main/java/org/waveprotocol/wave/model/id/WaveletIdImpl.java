 ...
 */
public final class WaveletIdImpl implements Comparable<WaveletId>, Serializable, WaveletId {
  ...
  public static WaveletId of(String domain, String id) {
    ...
    return new WaveletIdImpl(domain, id);
  }
  ...
  private WaveletIdImpl(String domain, String id) {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.model.id.WaveletId#getDomain()
 */
  @Override
public String getDomain() {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.model.id.WaveletId#getId()
 */
  @Override
public String getId() {
    return id;
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.model.id.WaveletId#serialise()
 */
  @Override
public String serialise() {
  ...
  public boolean equals(Object obj) {
    ...
    return domain.equals(other.getDomain()) && id.equals(other.getId());
  }
