...
public class IdGeneratorImpl implements IdGenerator, IdConstants {
  ...
  public WaveId newWaveId() {
    return WaveIdImpl.of(defaultDomain, newId(WAVE_PREFIX));
  }

  @Override
  public WaveletId newConversationRootWaveletId() {
    return WaveletIdImpl.of(defaultDomain, CONVERSATION_ROOT_WAVELET);
  }

  @Override
  public WaveletId newConversationWaveletId() {
    return WaveletIdImpl.of(defaultDomain, newId(CONVERSATION_WAVELET_PREFIX));
  }

  @Override
  public WaveletId buildConversationRootWaveletId(WaveId waveId) {
    return WaveletIdImpl.of(waveId.getDomain(), CONVERSATION_ROOT_WAVELET);
  }
  ...
  public WaveletId newUserDataWaveletId(String address) {
    ...
    return WaveletIdImpl.of(userDomain, build(USER_DATA_WAVELET_PREFIX, address));
  }
