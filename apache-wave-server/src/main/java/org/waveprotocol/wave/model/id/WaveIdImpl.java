 ...
 */
public final class WaveIdImpl implements Comparable<WaveId>, Serializable, WaveId {
  ...
  public static WaveId of(String domain, String id) {
    ...
    return new WaveIdImpl(domain, id);
  }
  ...
  private WaveIdImpl(String domain, String id) {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.model.id.WaveId#getDomain()
 */
  @Override
public String getDomain() {
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.model.id.WaveId#getId()
 */
  @Override
public String getId() {
    return id;
  ...
  /* (non-Javadoc)
 * @see org.waveprotocol.wave.model.id.WaveId#serialise()
 */
  @Override
