 ...
 */
public class BlipImpl implements Blip, Serializable {
   ...
   */
  BlipImpl(String blipId, String initialContent, String parentBlipId, String threadId,
      Wavelet wavelet) {
   ...
   * @param wavelet the wavelet that owns this blip.
   */
  BlipImpl(String blipId, List<String> childBlipIds, String content, List<String> contributors,
   ...
   */
  private BlipImpl(BlipImpl other, OperationQueue operationQueue) {
  ...
  public BlipContentRefs all() {
    return BlipContentRefsImpl.all(this);
  }
  ...
  public BlipContentRefs all(String target) {
    return BlipContentRefsImpl.all(this, target, -1);
  }
  ...
  public BlipContentRefs all(String target, int maxResult) {
    return BlipContentRefsImpl.all(this, target, maxResult);
  }
  ...
  public BlipContentRefs all(ElementType target, Restriction... restrictions) {
    return BlipContentRefsImpl.all(this, target, -1, restrictions);
  }
  ...
  public BlipContentRefs all(ElementType target, int maxResult, Restriction... restrictions) {
    return BlipContentRefsImpl.all(this, target, maxResult, restrictions);
  }
  ...
  public BlipContentRefs at(int index) {
    return BlipContentRefsImpl.range(this, index, index + 1);
  }
  ...
  public BlipContentRefs range(int start, int end) {
    return BlipContentRefsImpl.range(this, start, end);
  }
  ...
  public BlipContentRefs append(BlipContent argument) {
    return BlipContentRefsImpl.all(this).insertAfter(argument);
  }
  ...
  public Blip proxyFor(String proxyForId) {
    ...
    return new BlipImpl(this, proxiedOperationQueue);
  }
  ...
  public static Blip deserialize(OperationQueue operationQueue, Wavelet wavelet,
    ...
    return new BlipImpl(blipId, childBlipIds, content, contributors, creator, lastModifiedTime,
